...
internal class ProductDescriptionTranslationResolver : IValueResolver<Product, ProductResult, string>
{
	private readonly ICultureService _cultureService;

	public ProductDescriptionTranslationResolver(ICultureService cultureService)
	{
